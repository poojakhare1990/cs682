...
<?php
    ...
    for($i = 0; $i < count($result); $i++)
    {
        ...
        echo "<td style='text-align:center'><button type='button' onclick='window.location.href=\"./getQuestion.php?username=".$username."&fid=".$fid."&fname=".$fname."&bid=".$bid."&manager=".$manager."&technician=".$technician."\"'><font size='3em'>SUBMIT FORM</font></button></td>";
