...
//        echo "<td><font color='white' size='5em'>".$bid."</font></td>";
        echo "<td style='text-align:center'><button type='button' onclick='window.location.href=\"./getQuestion.php?username=".$username."&fid=".$fid."&fname=".$fname."&bid=".$bid."&manager=".$manager."&technician=".$technician."\"'><font size='3em'>SELECT</font></button></td>";
